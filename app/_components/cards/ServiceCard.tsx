...
const ServiceCard = ({ title, text, value } : { title: string; text: string; value: string }) => {
  return (
    <div className="max-w-96 min-h-99 border border-[#e6e6e6] dark:border-[#262626] rounded-xl px-6 py-6 flex flex-col dark:bg-black hover:shadow-lg ease-in-out z-0">
      ...
      <div className=" flex items-center gap-2  mt-4  ">
        <Image src={"globe.svg"} alt="service icon" width={17} height={16} />
        <h3 className="text-lg font-semibold text-[#0a0a0a]  dark:text-gray-200">
          {title}
        </h3>
      </div>
