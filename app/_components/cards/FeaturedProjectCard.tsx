  ...
  return (
    <div className="max-w-96 min-h-95 border border-[#e6e6e6] dark:border-[#262626] rounded-xl px-6 py-6 flex flex-col dark:bg-black hover:shadow-lg ease-in-out z-0">
      ...
      <div className="mt-auto">
        ...
        <Link href={{ pathname: `/projects/${slug.current}`, query: {slug: slug.current}}} className="text-black hover:bg-gray-100 h-8 border-gray-200 border bg-white rounded-lg px-4 py-2 w-full mt-4   text-xs font-medium m flex items-center justify-center gap-2 duration-300 ease-in-out">
          View Case Study
        </Link>
      </div>
    </div>
